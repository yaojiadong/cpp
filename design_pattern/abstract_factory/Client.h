...
public:
	...
	std::unique_ptr<IProduct_a> create_product_a(){return factory->create_product_a();}
	std::unique_ptr<IProduct_b> create_product_b(){return factory->create_product_b();}

	void use_product_a(){ std::cout << create_product_a()->use_product_a() << std::endl;}
	void use_product_b(){ std::cout << create_product_b()->use_product_b() << std::endl;}
