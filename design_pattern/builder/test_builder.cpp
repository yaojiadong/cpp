...
void test_builder(){
	...
	std::shared_ptr<Product1> product1 = builder1->product1();  // get product from builder
	product1->ListParts();
	...
	client.ask_for_simple_product();
	std::shared_ptr<Product2> product2 = builder2->product2();  // get product from builder
	product2->ListParts();
