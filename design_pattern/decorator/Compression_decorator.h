...
public:
	...
	virtual void write_data(std::string& data) override {std::cout << "Data compressed\n"; Data_source_decorator::write_data(data);}
	virtual void read_data() const override {Data_source_decorator::read_data(); std::cout << "Data read and decompressed...\n";}
