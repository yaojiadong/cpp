...
#ifndef TREE_LINKED_BINARY_TREE2_H_
#define TREE_LINKED_BINARY_TREE2_H_
...
/*
 * The 2nd version of Linked binary tree class does not have the Position class and Node struct
 *
 */
...
public:
	...
	void addRoot(const E & elem){_root = new Node<E>(elem); n=1;}
...
#endif /* TREE_LINKED_BINARY_TREE2_H_ */
